...
<head>
  ...
  <title>Paramètres - Dashboard Déménagement</title>
...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
  <div class="flex flex-col md:flex-row">
    ...
    <main class="flex-1 p-6 space-y-6">
      ...
      <!-- Bloc Logo & Arrière-plan -->
      <section class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        <h2 class="text-2xl font-bold mb-4">Logo & Arrière-plan</h2>
        <div class="mb-4">
          <label class="block mb-2">Changer le Logo :</label>
          <input type="file" class="p-2 border rounded-md bg-gray-50 dark:bg-gray-700">
        </div>
        <div>
          <label class="block mb-2">Changer l'Arrière-plan :</label>
          <input type="file" class="p-2 border rounded-md bg-gray-50 dark:bg-gray-700">
        </div>
      </section>
      ...
      <section class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        ...
        <div class="mb-4">
          ...
          <input type="text" class="w-full p-2 border rounded-md bg-gray-50 dark:bg-gray-700" placeholder="Votre nom">
        </div>
        <div class="mb-4">
          <label class="block mb-2">Email :</label>
          <input type="email" class="w-full p-2 border rounded-md bg-gray-50 dark:bg-gray-700" placeholder="Votre email">
        </div>
        <div class="mb-4">
          <label class="block mb-2">Mot de passe :</label>
          <input type="password" class="w-full p-2 border rounded-md bg-gray-50 dark:bg-gray-700" placeholder="Votre mot de passe">
        </div>
