...
<head>
  ...
  <title>Modifier Commande - Dashboard Déménagement</title>
...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
  <div class="flex flex-col md:flex-row">
    ...
    <main class="flex-1 p-6">
      <h1 class="text-3xl font-semibold mb-4">Modifier la commande</h1>
      <form class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        <!-- Valeurs pré-remplies pour l'exemple -->
        <div class="mb-4">
          <label for="order-id" class="block text-lg font-medium mb-2">ID Commande</label>
          <input type="text" id="order-id" class="w-full p-2 border rounded-md bg-gray-50 dark:bg-gray-700" value="001" readonly>
        </div>
        <div class="mb-4">
          <label for="order-date" class="block text-lg font-medium mb-2">Date</label>
          <input type="date" id="order-date" class="w-full p-2 border rounded-md bg-gray-50 dark:bg-gray-700" value="2025-02-22">
        </div>
        <div class="mb-4">
        ...
        <div class="flex space-x-2">
          <button type="submit" class="px-4 py-2 bg-yellow-500 text-white rounded-md hover:bg-yellow-600">Enregistrer les modifications</button>
